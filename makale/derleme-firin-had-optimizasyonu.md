...
**2.3. Zaman aralığı ve havuzun bileşimi.** Uygulama çalışmaları için 2000-2026 aralığı esas alınmış; metodolojik birincil kaynaklar bakımından bu sınır uygulanmamıştır (en eski kaynak 1974). Nihai havuz **44 kaynaktan** oluşmaktadır (Tablo 1):
